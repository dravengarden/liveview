...
const STRINGS: Record<Language, Dict> = {
  en: {
    ...
    "sort.added": "Added",
    "sort.name": "Name",
    "settings.navbar": "Navbar position",
    "settings.navbarDesc": "Bottom keeps it within thumb reach",
    "navbar.top": "Top",
  ...
  zh: {
    ...
    "audiobook.stopConfirmBody": "播放会停止，悬浮窗关闭。可随时从书架重新打开。",
    ...
    "settings.fontSizeDesc": "缩放整个应用的文字和图标",
    "settings.contentWidth": "内容宽度",
    "settings.margin": "页边距",
    "settings.marginDesc": "正文两侧的留白",
    "settings.marginNone": "无",
    ...
    "sort.added": "最近添加",
    "sort.name": "名称",
    "settings.navbar": "导航栏位置",
    "settings.navbarDesc": "放到底部，拇指更容易够到",
    "navbar.top": "顶部",
    "navbar.bottom": "底部",
    "settings.about": "关于",
