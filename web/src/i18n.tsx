...
const STRINGS: Record<Language, Dict> = {
  en: {
    ...
    "sync.offlineSoon": "Reading is cached offline; offline listening is coming.",
    "sync.failedCount": "{n} failed",
    "sync.offlineHint": "Reading is always cached. Toggle a book to keep its audio offline.",
    "sync.offlineAuto": "Saved offline automatically — reading as you open, audio as you listen.",
