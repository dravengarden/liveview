...
// Reading font-size multipliers (1 = unchanged). Mostly an enlarge range, since
// readers reach for this to make body text bigger; shown as percentages.
const FONT_SCALE_PRESETS = [0.8, 0.9, 1, 1.1, 1.25, 1.4, 1.6];
