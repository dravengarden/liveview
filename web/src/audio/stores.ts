 ...
 *  on startup, flush on pagehide). Each device plays independently — there is no
 *  cross-device "single active player" mutual exclusion; these stores only carry
 *  the resume pointer + preferences, never a "who's playing" claim. */
